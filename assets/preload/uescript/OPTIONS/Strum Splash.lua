...
function onCreatePost()
    if strumsplash then
        ...
        for i = 0, 3 do
            ...
            makeAnimatedLuaSprite("redthingnote", strumFile .. "holdCoverRed", posXR - 107, posY - 80)
            addAnimationByPrefix("redthingnote", "push", "holdCoverRed", 24, false)
            makeAnimatedLuaSprite("purple", strumFile .. "holdCoverPurple", posXP - 107, posY - 80)
            addAnimationByPrefix("purple", "idle", "holdCoverPurple0", 24, false)
            makeAnimatedLuaSprite("blue", strumFile .. "blueShit", posXB - 107, posY - 80)
            addAnimationByPrefix("blue", "push", "holdCoverBlue", 24, false)
            makeAnimatedLuaSprite("green", strumFile .. "holdCoverGreen", posXG - 107, posY - 80)
