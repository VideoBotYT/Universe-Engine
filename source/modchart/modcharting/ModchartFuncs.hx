...
import modchart.modcharting.ModchartUtil;
...
class ModchartFuncs
{
    ...
    public static function startMod(name:String, modClass:String, type:String = '', pf:Int = -1, ?instance:ModchartMusicBeatState = null)
    {
        ...
        var mod = Type.resolveClass('modchart.modcharting.'+modClass);
        if (mod == null) {mod = Type.resolveClass('modchart.modcharting.'+modClass+"Modifier");} //dont need to add "Modifier" to the end of every mod
